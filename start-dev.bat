...
start "CMC API" /D "%~dp0services\api" cmd /k "color 0A && echo. && echo ========================================== && echo CMC API && echo ========================================== && echo. && call npm run dev"
start "CMC WEB" /D "%~dp0apps\web" cmd /k "color 0B && echo. && echo ========================================== && echo CMC WEB && echo ========================================== && echo. && call npm run dev -- --host 127.0.0.1 --port 5173"
